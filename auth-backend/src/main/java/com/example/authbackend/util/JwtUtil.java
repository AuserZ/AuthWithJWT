...
public class JwtUtil {
    ...
    public String generateAccessToken(String id, String username){
        return generateToken(id, ACCESS_TOKEN_EXPIRATION, "access", username);
    }

    public String generateRefreshToken(String id, String username){
        return generateToken(id, REFRESH_TOKEN_EXPIRATION, "refresh", username);
    }

    public String generateToken(String id, long expiration, String tokenType, String username){
        return Jwts.builder()
                .setSubject(id)
