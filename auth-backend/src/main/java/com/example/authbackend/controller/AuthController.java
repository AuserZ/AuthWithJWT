...
public class AuthController {
    ...
    public ResponseEntity<?> login(@RequestBody LoginRequest loginRequest) throws Exception {
        ...
        if(ObjectUtils.isEmpty(loginRequest.getUsername()) || ObjectUtils.isEmpty(loginRequest.getPassword())) {
            ...
            LOGGER.error("Request:{}", loginRequest);
    ...
    public ResponseEntity<?> refresh(@RequestBody RefreshRequest refreshRequest) throws Exception {
        ...
        AuthEntity user = authRepository.findById(claimsjwt.getSubject()).orElse(null);
        ...
        try {
            ...
            String newRefreshToken = jwtUtil.generateRefreshToken(id, username);
    ...
    public ResponseEntity<?> logout(@RequestBody LogoutRequest logoutRequest) throws Exception {
        ...
        if(ObjectUtils.isEmpty(logoutRequest))
            throw new IllegalArgumentException("Token cannot be empty");

        try {
            if(!jwtUtil.validateToken(logoutRequest.getAccessToken()))
