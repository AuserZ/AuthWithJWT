  ...
  async function handleRegister() {
    ...
    try {
      ...
      if (res.status === 201) {
        ...
        setError(`Failed to register user, ${res.data.error}: ${res.data.message}`)
      }
    } catch (e) {
      setError("Failed to register user. Please contact support team")
    } finally {
      setIsLoading(false)
    }
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        ...
        <form action={handleRegister} className="mt-8 space-y-6 bg-white p-8 shadow-md rounded-lg">
